...
// get_contract
List get_contract(double gamma, double alpha, double D_max, double X_max, NumericVector Dstar, NumericVector Xstar, double popn);
RcppExport SEXP _forcedMigration_get_contract(SEXP gammaSEXP, SEXP alphaSEXP, SEXP D_maxSEXP, SEXP X_maxSEXP, SEXP DstarSEXP, SEXP XstarSEXP, SEXP popnSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(get_contract(gamma, alpha, D_max, X_max, Dstar, Xstar, popn));
    return rcpp_result_gen;
END_RCPP
}
// get_surplus
