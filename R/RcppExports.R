...
get_contract <- function(gamma, alpha, D_max, X_max, Dstar, Xstar, popn) {
    .Call('_forcedMigration_get_contract', PACKAGE = 'forcedMigration', gamma, alpha, D_max, X_max, Dstar, Xstar, popn)
}
