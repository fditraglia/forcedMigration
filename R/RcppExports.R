...
get_payoffs <- function(delta, tau_ell, tau_n, r, a0, a1, p, q, H_bar, omega_n, popn) {
    .Call('forcedMigration_get_payoffs', PACKAGE = 'forcedMigration', delta, tau_ell, tau_n, r, a0, a1, p, q, H_bar, omega_n, popn)
}
